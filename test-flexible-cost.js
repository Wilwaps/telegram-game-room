// Script para debuggear TTT con costos flexibles
...
mem.addFiresAdmin({ userId: 'test:host', amount: 50, reason: 'test_funds' });
mem.addFiresAdmin({ userId: 'test:guest', amount: 50, reason: 'test_funds' });
...
// Crear una sala de prueba con costo personalizado
const room = ttt.createRoom('test:host', { 
  visibility: 'private', 
  costType: 'fuego', 
  costValue: 15  // Costo personalizado
});

console.log('\nSala creada con costo:', room.costValue, room.costType);
